...
##################################################
def obtener_rectangulo_boss(principal):
    
   diccionario = {}
   diccionario["main"] = principal
   diccionario["bottom"] = pygame.Rect(principal.left+17, principal.bottom -5, principal.width-31, 5)
   diccionario["right"] = pygame.Rect(principal.right -2, principal.top+100, 5, principal.height-100)
   diccionario["left"] = pygame.Rect(principal.left+20, principal.top+100,5,principal.height-100)
   diccionario["top"] = pygame.Rect(principal.left +30, principal.top+60, principal.width - 90, 10)
   diccionario["cabeza"] = pygame.Rect(principal.left +100,principal.top+120 , principal.height-200 ,50)
   diccionario["torso"] = pygame.Rect(principal.left +100,principal.top+200 , principal.height-200 ,50)
