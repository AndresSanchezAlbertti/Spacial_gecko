...
class Enemigo(pygame.sprite.Sprite):
    ...
    def recibe_danio(self,un_jugador,lista_enemigos):
        
        if self.cheq_col(un_jugador.lados["bottom"],self.rectangulo):
            self.esta_muerto = True
            self.matar_enemigo(lista_enemigos)
        for disparo in un_jugador.listaDisparo:
            if self.cheq_col(disparo.rect,self.rectangulo):
                self.matar_enemigo(lista_enemigos)      
